...
- Management can keep someone out of a given shift by rating them as a 0 for that shift. If you do this like crazy, though, you may run into a scheduling problem without a solution because not all the constraints can be satisfied
